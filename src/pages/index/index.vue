...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //获取倒计时
      async getSeconds() {
        // let result = await Taro.request({url: this.backUrl + '/getSecond'})
        // this.countDownSecond = result.data.data.seconds
        this.countDownSecond = 60000
      },
      //获取一封信
      async getLetter() {
        // let result = await Taro.request({url: this.backUrl + '/getLetter'})
        ...
        this.letterInfo = 111111111
        this.currentLetterId = 2222222
        this.likeNum = 33
        this.getNum = 44444
        this.likeSend = true
        window.scrollTo(0, 0)
      ...
      async sendLetter() {
        // await Taro.request({
        //   url: this.backUrl + '/createLetter', data: {
      ...
      async like() {
        ...
        //   url: this.backUrl + '/likeLetter', data: {
